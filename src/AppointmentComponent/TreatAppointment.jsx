...
const TreatAppointment = () => {
  ...
  const retrieveAppointment = async () => {
    const response = await axios.get("http://10.100.1.2:8080/api/appointment/id?appointmentId="+appointmentId);
  ...
  const saveAppointment = () => {
    ...
    axios
      .post("http://10.100.1.2:8080/api/appointment/doctor/update", formData)
      .then((result) => {
