...
const AssignAppointment = () => {
  ...
  const retrieveAppointment = async () => {
    const response = await axios.get(
      "http://10.100.1.2:8080/api/appointment/id?appointmentId=" + appointmentId
    );
  ...
  const retrieveAllDoctor = async () => {
    const response = await axios.get("http://10.100.1.2:8080/api/doctor/all");
  ...
  const saveAppointment = () => {
    ...
    axios
      .post(
        "http://10.100.1.2:8080/api/appointment/admin/assign/doctor",
        formData
      )
      .then((result) => {
