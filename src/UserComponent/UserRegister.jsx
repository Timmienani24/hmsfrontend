...
const UserRegister = () => {
  ...
  const retrieveAllGenders = async () => {
    const response = await axios.get("http://10.100.1.2:8080/api/user/gender");
    return response.data;
  };

  const retrieveAllBloodGroups = async () => {
    const response = await axios.get(
      "http://10.100.1.2:8080/api/patient/bloodgroup/all"
    );
    return response.data;
  };
  ...
  const retrieveAllSpecialist = async () => {
    const response = await axios.get(
      "http://10.100.1.2:8080/api/doctor/specialist/all"
    );
    return response.data;
  };
  ...
  const saveUser = (event) => {
    ...
    fetch("http://10.100.1.2:8080/api/user/register", {
      method: "POST",
      headers: {
